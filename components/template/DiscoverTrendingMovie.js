...
function DiscoverTrendingMovie({ title, movies }) {
  return (
    <section className="bg-base-200/50  my-4">
      <h2
      ...
      <ul className="flex flex-wrap  justify-center gap-6 px-4 py-8">
        {movies &&
...
export default DiscoverTrendingMovie;
