import FlexMoviePoster from "./FlexMoviePoster";

export default function FlexMovie({ genresName, genresMovie }) {
  const Movie = [
    {
      adult: false,
  ...
  return (
    <div className="p-4 container mx-auto ">
      ...
      <ul className="flex overflow-x-auto w-full bg-base-200 p-2 gap-1 ">
        {genresMovie.map((oneMovie) => (
          <li
            key={oneMovie.id}
            className="h-56 sm:h-64 md:h-72 lg:h-80 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 border shadow border-opacity-20 overflow-hidden rounded  flex-shrink-0"
          >
